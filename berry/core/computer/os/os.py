    ...
    def notify(self, text):
        ...
        try:
            ...
            if "darwin" in platform.system().lower():  # Check if the OS is macOS
                ...
                # ## DISABLED berry-notifier.app
                # (This does not work. It makes `pip uninstall`` break for some reason!)

                # ## Use berry-notifier.app, which lets us use a custom icon
                ...
                # # Construct the path to the berry-notifier.app
                # notifier_path = os.path.join(script_path, "berry-notifier.app")

                # # Call the berry-notifier
