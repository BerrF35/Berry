...
def find_icon(description, screenshot=None, debug=False, hashes=None):
    ...
    debug_path = os.path.join(os.path.expanduser("~"), "Desktop", "berry-debug")
    ...
    # Filter out extremes
    min_icon_width = int(os.getenv("berry_POINT_MIN_ICON_WIDTH", "10"))
    max_icon_width = int(os.getenv("berry_POINT_MAX_ICON_WIDTH", "500"))
    min_icon_height = int(os.getenv("berry_POINT_MIN_ICON_HEIGHT", "10"))
    max_icon_height = int(os.getenv("berry_POINT_MAX_ICON_HEIGHT", "500"))
    ...
    pixel_expand = int(os.getenv("berry_POINT_PIXEL_EXPAND", 7))
    ...
    if os.getenv("berry_POINT_OVERLAP", "True") == "True":
...
def get_element_boxes(image_data, debug):
    ...
    debug_path = os.path.join(desktop_path, "berry-debug")
    ...
    if os.getenv("berry_POINT_PERMUTATE", "False") == "True":
        import random
