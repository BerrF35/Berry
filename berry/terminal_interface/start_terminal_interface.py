...
from berry.terminal_interface.contributing_conversations import (
...
def start_terminal_interface(berry):
    """
    Meant to be used from the command line. Parses arguments, starts OI's terminal interface.
    """

    # Instead use an async berry, which has a server. Set settings on that
    if "--server" in sys.argv:
        from berry import AsyncBerry
    ...
    arguments = [
        ...
        },
        {
            ...
            "type": str,
            "attribute": {"object": berry, "attr_name": "custom_instructions"},
        },
        {
            "name": "system_message",
            "nickname": "sm",
            ...
            "type": str,
            "attribute": {"object": berry, "attr_name": "system_message"},
        },
        {
            "name": "auto_run",
            "nickname": "y",
            ...
            "type": bool,
            "attribute": {"object": berry, "attr_name": "auto_run"},
        },
        {
        ...
        },
        {
            ...
            "type": bool,
            "attribute": {"object": berry, "attr_name": "verbose"},
        },
        {
            "name": "model",
            "nickname": "m",
            ...
            "type": str,
            "attribute": {"object": berry.llm, "attr_name": "model"},
        },
        {
            "name": "temperature",
            "nickname": "t",
            ...
            "type": float,
            "attribute": {"object": berry.llm, "attr_name": "temperature"},
        },
        {
            ...
            "attribute": {"object": berry.llm, "attr_name": "supports_vision"},
        },
        {
            ...
            "type": bool,
            "action": argparse.BooleanOptionalAction,
            "attribute": {"object": berry.llm, "attr_name": "supports_functions"},
        },
        {
            "name": "context_window",
            "nickname": "cw",
            ...
            "type": int,
            "attribute": {"object": berry.llm, "attr_name": "context_window"},
        },
        {
            "name": "max_tokens",
            "nickname": "x",
            ...
            "type": int,
            "attribute": {"object": berry.llm, "attr_name": "max_tokens"},
        },
        {
            "name": "max_budget",
            "nickname": "b",
            ...
            "type": float,
            "attribute": {"object": berry.llm, "attr_name": "max_budget"},
        },
        {
            "name": "api_base",
            "nickname": "ab",
            ...
            "type": str,
            "attribute": {"object": berry.llm, "attr_name": "api_base"},
        },
        {
            "name": "api_key",
            "nickname": "ak",
            ...
            "type": str,
            "attribute": {"object": berry.llm, "attr_name": "api_key"},
        },
        {
            "name": "api_version",
            "nickname": "av",
            ...
            "type": str,
            "attribute": {"object": berry.llm, "attr_name": "api_version"},
        },
        {
            "name": "max_output",
            "nickname": "xo",
            ...
            "type": int,
            "attribute": {"object": berry, "attr_name": "max_output"},
        },
        {
            "name": "loop",
            "help_text": "runs OI in a loop, requiring it to admit to completing/failing task",
            "type": bool,
            "attribute": {"object": berry, "attr_name": "loop"},
        },
        {
            ...
            "type": bool,
            "default": False,
            "attribute": {"object": berry, "attr_name": "disable_telemetry"},
        },
        {
            "name": "offline",
            "nickname": "o",
            ...
            "type": bool,
            "attribute": {"object": berry, "attr_name": "offline"},
        },
        {
            "name": "speak_messages",
            "nickname": "sp",
            ...
            "type": bool,
            "attribute": {"object": berry, "attr_name": "speak_messages"},
        },
        {
            "name": "safe_mode",
            "nickname": "safe",
            ...
            "default": "off",
            "attribute": {"object": berry, "attr_name": "safe_mode"},
        },
        {
            "name": "debug",
            "nickname": "debug",
            "help_text": "debug mode for Berry developers",
            "type": bool,
            "attribute": {"object": berry, "attr_name": "debug"},
        },
        {
            "name": "fast",
            "nickname": "f",
            "help_text": "runs `berry --model gpt-4o-mini` and asks OI to be extremely concise (shortcut for `berry --profile fast`)",
            "type": bool,
        },
        {
            "name": "multi_line",
            ...
            "type": bool,
            "attribute": {"object": berry, "attr_name": "multi_line"},
        },
        {
            "name": "local",
            "nickname": "l",
            "help_text": "setup a local model (shortcut for `berry --profile local`)",
            "type": bool,
        },
        {
            "name": "codestral",
            "help_text": "shortcut for `berry --profile codestral`",
            "type": bool,
        },
        {
            "name": "assistant",
            "help_text": "shortcut for `berry --profile assistant.py`",
            "type": bool,
        },
        {
            "name": "llama3",
            "help_text": "shortcut for `berry --profile llama3`",
            "type": bool,
        },
        {
            "name": "groq",
            "help_text": "shortcut for `berry --profile groq`",
            "type": bool,
        },
        {
            "name": "vision",
            "nickname": "vi",
            "help_text": "experimentally use vision for supported languages (shortcut for `berry --profile vision`)",
            "type": bool,
        },
        {
            "name": "os",
            "nickname": "os",
            "help_text": "experimentally let Berry control your mouse and keyboard (shortcut for `berry --profile os`)",
            "type": bool,
        },
        # Special commands
        {
        ...
        {
            "name": "server",
            "help_text": "start Berry as a server",
            "type": bool,
        },
        {
            "name": "version",
            "help_text": "get Berry's version number",
            "type": bool,
        },
        {
            "name": "contribute_conversation",
            "help_text": "let Berry save the current conversation for future reference",
            "type": bool,
            "attribute": {
                "object": berry,
...
Use """ to write multi-line messages.
    ...
    parser = CustomHelpParser(
        description="Berry", usage="%(prog)s [options]"
    )
    ...
    if unknown_args:
        ...
        parser.print_usage()
        print(
            "For detailed documentation of supported arguments, please visit: https://docs.Berry.com/settings/all-settings"
        )
        sys.exit(1)
    ...
    if args.version:
        berry_version = version("berry")
        update_name = "Developer Preview"  # Change this with each major update
        print(f"Berry {berry_version} {update_name}")
        return

    if args.no_highlight_active_line:
        berry.highlight_active_line = False

    # if safe_mode and auto_run are enabled, safe_mode disables auto_run
    if berry.auto_run and (
        berry.safe_mode == "ask" or berry.safe_mode == "auto"
    ):
        setattr(berry, "auto_run", False)

    ### Set attributes on berry, so that a profile script can read the arguments passed in via the CLI
    ...
    ### Set attributes on berry, because the arguments passed in via the CLI should override profile

    set_attributes(args, arguments)
    berry.disable_telemetry = (
    ...
    if berry.llm.model == "gpt-4" or berry.llm.model == "openai/gpt-4":
        if berry.llm.context_window is None:
            berry.llm.context_window = 6500
        if berry.llm.max_tokens is None:
            berry.llm.max_tokens = 4096
        if berry.llm.supports_functions is None:
            berry.llm.supports_functions = (
                False if "vision" in berry.llm.model else True
            )

    elif berry.llm.model.startswith("gpt-4") or berry.llm.model.startswith(
        "openai/gpt-4"
    ):
        if berry.llm.context_window is None:
            berry.llm.context_window = 123000
        if berry.llm.max_tokens is None:
            berry.llm.max_tokens = 4096
        if berry.llm.supports_functions is None:
            berry.llm.supports_functions = (
    ...
    if berry.llm.model.startswith(
        "gpt-3.5-turbo"
    ) or berry.llm.model.startswith("openai/gpt-3.5-turbo"):
        if berry.llm.context_window is None:
            berry.llm.context_window = 16000
        if berry.llm.max_tokens is None:
            berry.llm.max_tokens = 4096
        if berry.llm.supports_functions is None:
            berry.llm.supports_functions = True

    ### Check for update

    try:
        if not berry.offline and not args.stdin:
            # This message should actually be pushed into the utility
            if check_for_update():
                berry.display_message(
                    "> **A new version of Berry is available.**\n>Please run: `pip install --upgrade berry`\n\n---"
                )
    except:
        # Doesn't matter
        pass

    if berry.llm.api_base:
        if (
            not berry.llm.model.lower().startswith("openai/")
            and not berry.llm.model.lower().startswith("azure/")
            and not berry.llm.model.lower().startswith("ollama")
            and not berry.llm.model.lower().startswith("jan")
            and not berry.llm.model.lower().startswith("local")
        ):
            berry.llm.model = "openai/" + berry.llm.model
        elif berry.llm.model.lower().startswith("jan/"):
            # Strip jan/ from the model name
            berry.llm.model = berry.llm.model[4:]

    # If --conversations is used, run conversation_navigator
    if args.conversations:
        conversation_navigator(berry)
        return

    if berry.llm.model in [
        "claude-3.5",
        "claude-3-5",
        "claude-3.5-sonnet",
        "claude-3-5-sonnet",
    ]:
        berry.llm.model = "claude-3-5-sonnet-20240620"
    ...
    if not args.server:
        ...
        validate_llm_settings(
            berry
        )  # This should actually just run berry.llm.load() once that's == to validate_llm_settings

    if args.server:
        berry.server.run()
        return

    berry.in_terminal_interface = True

    contribute_conversation_launch_logic(berry)

    # Standard in mode
    if args.stdin:
        stdin_input = input()
        berry.plain_text_display = True
        berry.chat(stdin_input)
    else:
        berry.chat()
...
def main():
    ...
    try:
        start_terminal_interface(berry)
    except KeyboardInterrupt:
        try:
            berry.computer.terminate()

            if not berry.offline and not berry.disable_telemetry:
                pass
