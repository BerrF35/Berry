...
def handle_help(self, arguments):
    commands_description = {
        ...
        "%info": "Show system and berry information",
...
def handle_count_tokens(self, prompt):
    ...
    outputs.append(
        f"**Note**: This functionality is currently experimental and may not be accurate. Please report any issues you find to the [Berry GitHub repository](https://github.com/Berry/berry)."
    )
...
def jupyter(self, arguments):
    ...
    filename = f"berry-{formatted_time}.ipynb"
