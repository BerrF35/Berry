...
class PythonE2B:
    """
    This class contains all requirements for being a custom language in Berry:
...
# Give Berry its languages. This will only let it run PythonE2B:
berry.computer.languages = [PythonE2B]
