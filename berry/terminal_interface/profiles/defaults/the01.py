...
# This is an Berry compatible profile.
# Visit https://01.Berry.com/profile for all options.
...
berry.llm.model = "claude-3.5"
# berry.llm.model = "gpt-4o-mini"
berry.llm.context_window = 100000
berry.llm.max_tokens = 4096
# berry.llm.api_key = "<your_openai_api_key_here>"

# Tell your 01 where to find and save skills
skill_path = "./skills"
berry.computer.skills.path = skill_path
...
berry.computer.import_skills = True
