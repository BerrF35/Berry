...
try:
    ...
    print(
        "Some actions may fail as OS dependencies are not installed. Please run 'pip install berry[os]' to install them."
    )
...
berry.computer.skills.path = "./skills"

# Extra settings
berry.computer.import_computer_api = True
berry.computer.import_skills = True
berry.computer.run("python", "computer")  # This will trigger those imports
berry.auto_run = True
berry.print = True
berry.loop = True
