"""
This is an Berry profile specialized for searching ScreenPipe history.
...
# Add the custom tool to the berry's environment
...
results = search_screenpipe("Berry", limit=3)
