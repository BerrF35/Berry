...
if missing_packages:
    print(
        '{} isn\'t installed. Please run `pip install "berry[os]"` to install all required packages for OS mode'.format(
...
berry.display_message(
    "\n**Note:** Codestral is a relatively weak model, so OS mode is highly experimental. Try using a more powerful model for OS mode with `berry --os`."
)
berry.display_message("> Experimental OS control enabled.")
