...
echo "Starting Berry installation..."
sleep 2
...
if [[ $installed_version != *"$python_version"* ]]; then
    echo "Python $python_version was not installed correctly. Please open an issue at https://github.com/berry/universal-python/."
    exit 1
fi

# Use the specific Python version to install berry
$pyenv_root exec python$python_version -m pip install berry

echo "Berry has been installed. Run the following command to use it:"
echo "berry"
